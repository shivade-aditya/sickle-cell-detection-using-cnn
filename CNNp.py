def main():
    ...
    basepath="C:/Users/tejas/OneDrive/Desktop/Sickel cell detection"
    
    # Initializing the CNN
    classifier = Sequential()
    
    # Step 1 - Convolution Layer 
    classifier.add(Convolution2D(32, 1,  1, input_shape=(64, 64, 3), activation='ELU'))
    
    # Step 2 - Pooling
    classifier.add(MaxPooling2D(pool_size=(2, 2)))
    
    # Adding second convolution layer
    classifier.add(Convolution2D(32, 1,  1, activation='ELU'))
    classifier.add(MaxPooling2D(pool_size=(2, 2)))
    
    # Adding 3rd Convolution Layer
    classifier.add(Convolution2D(64, 1,  1, activation='ELU'))
    classifier.add(MaxPooling2D(pool_size=(2, 2)))
    ...
    # Saving the model
    # import h5py
    classifier.save(basepath + '/cell_modelnew.h5')
